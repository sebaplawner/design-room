...
<html lang="es">
	...
	<body id="design-room" class="purple">
								...
								<div class="design-container"> 
									<div class="content">
										<div class="design-image"> 
											<div class="content">
												<img src="images/Chomba/chomba_con_botones.png" class="img-responsive" title="Con botones" alt="Follow Me - Con botones"/>
											</div> 
										</div>                  
										<p class="design-title">Con botones</p>
									</div> 
								</div>
							</div>
							...
							<div class="item">
								<div class="design-container"> 
									<div class="content">
										<div class="design-image"> 
											<div class="content">
												<img src="images/Chomba/chomba_sin_botones.png" class="img-responsive" title="Sin botones" alt="Follow Me - Sin botones"/>
											</div> 
										</div>                  
										<p class="design-title">Sin botones</p>
									</div> 
								</div>
							</div>
		...
		<script src="../js/design-room/chombas-paso-02.js"></script>
