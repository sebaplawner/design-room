...
<html lang="es">
  ...
  <section class="big-jumbotrom">
    <div class="container">
      <div class="row header-images">
        <div class="col-xs-12"> 
          <img class="img-responsive" src="images/modelo-remeras.png" alt="Design Room">
          <h1>Remeras</h1>
        </div>
      </div>
    </div>
    <div class="divider-contain">
      ...
      <polygon class="st0" points="0,168.2 1920.6,168.2 1919.6,0 0,167.5 "/>
      </svg>
    </div>
  </section>
  ...
  <section class="main-content">
    <div class="container">
              ...
              <div class="design-container"> 
                <div class="content">
                  <div class="design-image"> 
                    <div class="content">
                      <img src="images/Remera/remera_cuello_en_v.png" class="img-responsive" title="Cuello en V" alt="Follow Me - Cuello en V"/>
                    </div> 
                  </div>                  
                  <p class="design-title">Cuello en V</p>
                </div> 
              </div>
            </div>
            ...
            <div class="item">
              <div class="design-container"> 
                <div class="content">
                  <div class="design-image"> 
                    <div class="content">
                      <img src="images/Remera/remera_cuello_redondo.png" class="img-responsive" title="Cuello redondo" alt="Follow Me - Cuello redondo"/>
                    </div> 
                  </div>                  
                  <p class="design-title">Cuello redondo</p>
                </div> 
              </div>
            </div>
            ...
            <div class="item">
              <div class="design-container"> 
                <div class="content">
                  <div class="design-image"> 
                    <div class="content">
                      <img src="images/Remera/remera_cuello_bote.png" class="img-responsive" title="Cuello bote" alt="Follow Me - Cuello bote"/>
                    </div> 
                  </div>                  
                  <p class="design-title">Cuello bote</p>
                </div> 
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-xs-6">
          <a href="index.php" class="btn btn-design prev">Back</a>
        </div>
        <div class="col-xs-6">
  ...
  <script src="../js/design-room/remeras-paso-02.js"></script>
