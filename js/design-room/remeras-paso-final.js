$(document).ready(function () {
	...
	var cuello = ["Cuello en V", "Cuello redondo", "Cuello bote"]; 
	...
	function chombas() {
		addToArray("images/Remera/remeras/Frente/fondo_blanco.png", "fondo", true, true, 0);
		if (act_cuello == "en_v") {
			addToArray("images/Remera/remeras/Frente/fondo_sombra2.png", "fondo", true, false, 1);
		} else if (act_cuello == "redondo") {
			addToArray("images/Remera/remeras/Frente/fondo_sombra3.png", "fondo", true, false, 1);
		} else if (act_cuello == "bote") {
			addToArray("images/Remera/remeras/Frente/fondo_sombra1.png", "fondo", true, false, 1);
		}

		addToArray("images/Remera/remeras/Espalda/fondo_blanco.png", "fondo", false, true, 0);
		addToArray("images/Remera/remeras/Espalda/fondo_sombra.png", "fondo", false, false, 1);

		addOptionsToColor(["fondo"]);
		addOptionsToTextures(["fondo"]);
	}
	...
	$('#texture_palette > div > div > div > img').on('click', function () {
		...
		imageObj.src = "images/Remera/remeras/Frente/Tramas/" + src + aux + ".png";
		...
		if (id == "fondo" || id == "cuello") {
			...
			imageObj2.src = "images/Remera/remeras/Espalda/Tramas/" + src + aux + ".png";
		}
	...
	$(".btn.btn-design.next").on("click", function () {
		$('#checkOut').append('<input type="hidden" name="prenda" value="REMERA"/>');
