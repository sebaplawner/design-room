$(document).ready(function () {
	...
	var cuello = ["Cuello en V con capucha", "Cuello en V sin capucha", "Cuello rugby con capucha", "Cuello rugby sin capucha"];
	...
	function setImages() {
		...
		if (act_cuello == "en_v_con_capucha") {
			en_v_con_capucha();
	...
	function en_v_con_capucha() {
		addToArray("images/Buzo/con_capucha/en_v/frente/fondo_blanco.png", "fondo", true, true, 0);
		if (act_bolsillo == "inclinado") {
			addToArray("images/Buzo/con_capucha/en_v/frente/inclinado_blanco.png", "bolsillo", true, true, 1);
			addToArray("images/Buzo/con_capucha/en_v/frente/inclinado_sombra.png", "bolsillo", true, false, 2);
		} else if (act_bolsillo == "canguro") {
			addToArray("images/Buzo/con_capucha/en_v/frente/canguro_blanco.png", "bolsillo", true, true, 1);
			addToArray("images/Buzo/con_capucha/en_v/frente/canguro_sombra.png", "bolsillo", true, false, 2);
		} else if (act_bolsillo == "sin_bolsillo") {
			addToArray("images/Buzo/con_capucha/en_v/frente/sinbolsillo_sombra.png", "bolsillo", true, false, 2);
		}
		addToArray("images/Buzo/con_capucha/en_v/frente/cuello_blanco.png", "cuello", true, true, 1);
		if (act_cordones == "con_cordones") {
			addToArray("images/Buzo/con_capucha/en_v/frente/cordones_blanco.png", "cordones", true, true, 4);
			addToArray("images/Buzo/con_capucha/en_v/frente/cordones_sombra.png", "cordones", true, false, 5);
		}
		addToArray("images/Buzo/con_capucha/en_v/frente/capucha_blanco.png", "capucha", true, true, 1);
		if(act_punio_y_cintura == "tejido")
			addToArray("images/Buzo/con_capucha/en_v/frente/tejido_blanco.png", "tejido", true, true, 1);

		addToArray("images/Buzo/con_capucha/en_v/espalda/fondo_blanco.png", "fondo", false, true, 0);
		if(act_punio_y_cintura == "tejido")
			addToArray("images/Buzo/con_capucha/en_v/espalda/tejido_blanco.png", "tejido", false, true, 1);
		addToArray("images/Buzo/con_capucha/en_v/espalda/fondo_sombra.png", "fondo", false, false, 2);

		addOptionsToColor(["fondo", "bolsillo", "cuello", "cordones", "capucha", "tejido"]);
		addOptionsToTextures(["fondo", "bolsillo", "cuello", "capucha"]);
	}

	function en_v_sin_capucha() {
		addToArray("images/Buzo/sin_capucha/en_v/frente/fondo_blanco.png", "fondo", true, true, 0);
		if (act_bolsillo == "inclinado") {
			addToArray("images/Buzo/sin_capucha/en_v/frente/inclinado_blanco.png", "bolsillo", true, true, 1);
			addToArray("images/Buzo/sin_capucha/en_v/frente/inclinado_sombra.png", "bolsillo", true, false, 2);
		} else if (act_bolsillo == "canguro") {
			addToArray("images/Buzo/sin_capucha/en_v/frente/canguro_blanco.png", "bolsillo", true, true, 1);
			addToArray("images/Buzo/sin_capucha/en_v/frente/canguro_sombra.png", "bolsillo", true, false, 2);
		} else if (act_bolsillo == "sin_bolsillo") {
			addToArray("images/Buzo/sin_capucha/en_v/frente/sinbolsillo_sombra.png", "bolsillo", true, false, 2);
		}
		addToArray("images/Buzo/sin_capucha/en_v/frente/cuello_blanco.png", "cuello", true, true, 1);
		if(act_punio_y_cintura == "tejido")
			addToArray("images/Buzo/sin_capucha/en_v/frente/tejido_blanco.png", "tejido", true, true, 1);

		addToArray("images/Buzo/sin_capucha/en_v/espalda/fondo_blanco.png", "fondo", false, true, 0);
		addToArray("images/Buzo/sin_capucha/en_v/espalda/cuello_blanco.png", "cuello", false, true, 1);
		if(act_punio_y_cintura == "tejido")
			addToArray("images/Buzo/sin_capucha/en_v/espalda/tejido_blanco.png", "tejido", false, true, 1);
		addToArray("images/Buzo/sin_capucha/en_v/espalda/fondo_sombra.png", "fondo", false, false, 2);

		addOptionsToColor(["fondo", "bolsillo", "cuello", "tejido"]);
		addOptionsToTextures(["fondo", "bolsillo", "cuello"]);
	}

	function rugby_con_capucha() {
		addToArray("images/Buzo/con_capucha/rugby/frente/fondo_blanco.png", "fondo", true, true, 0);
		if (act_bolsillo == "inclinado") {
			addToArray("images/Buzo/con_capucha/rugby/frente/inclinado_blanco.png", "bolsillo", true, true, 1);
			addToArray("images/Buzo/con_capucha/rugby/frente/inclinado_sombra.png", "bolsillo", true, false, 2);
		} else if (act_bolsillo == "canguro") {
			addToArray("images/Buzo/con_capucha/rugby/frente/canguro_blanco.png", "bolsillo", true, true, 1);
			addToArray("images/Buzo/con_capucha/rugby/frente/canguro_sombra.png", "bolsillo", true, false, 2);
		} else if (act_bolsillo == "sin_bolsillo") {
			addToArray("images/Buzo/con_capucha/rugby/frente/sinbolsillo_sombra.png", "bolsillo", true, false, 2);
		}
		addToArray("images/Buzo/con_capucha/rugby/frente/botones_sombra.png", "botones", true, false, 3);
		if (act_cordones == "con_cordones") {
			addToArray("images/Buzo/con_capucha/rugby/frente/cordones_blanco.png", "cordones", true, true, 4);
			addToArray("images/Buzo/con_capucha/rugby/frente/cordones_sombra.png", "cordones", true, false, 5);
		}
		addToArray("images/Buzo/con_capucha/rugby/frente/capucha_blanco.png", "capucha", true, true, 1);
		if(act_punio_y_cintura == "tejido")
			addToArray("images/Buzo/con_capucha/rugby/frente/tejido_blanco.png", "tejido", true, true, 1);

		addToArray("images/Buzo/con_capucha/en_v/espalda/fondo_blanco.png", "fondo", false, true, 0);
		if(act_punio_y_cintura == "tejido")
			addToArray("images/Buzo/con_capucha/rugby/espalda/tejido_blanco.png", "tejido", false, true, 1);
		addToArray("images/Buzo/con_capucha/en_v/espalda/fondo_sombra.png", "fondo", false, false, 1);

		addOptionsToColor(["fondo", "bolsillo", "cordones", "capucha", "tejido"]);
		addOptionsToTextures(["fondo", "bolsillo", "capucha"]);
	}

	function rugby_sin_capucha() {
		addToArray("images/Buzo/sin_capucha/rugby/frente/fondo_blanco.png", "fondo", true, true, 0);
		if (act_bolsillo == "inclinado") {
			addToArray("images/Buzo/sin_capucha/rugby/frente/inclinado_blanco.png", "bolsillo", true, true, 1);
			addToArray("images/Buzo/sin_capucha/rugby/frente/inclinado_sombra.png", "bolsillo", true, false, 2);
		} else if (act_bolsillo == "canguro") {
			addToArray("images/Buzo/sin_capucha/rugby/frente/canguro_blanco.png", "bolsillo", true, true, 1);
			addToArray("images/Buzo/sin_capucha/rugby/frente/canguro_sombra.png", "bolsillo", true, false, 2);
		} else if (act_bolsillo == "sin_bolsillo") {
			addToArray("images/Buzo/sin_capucha/rugby/frente/sinbolsillo_sombra.png", "bolsillo", true, false, 2);
		}
		addToArray("images/Buzo/sin_capucha/rugby/frente/cuello_blanco.png", "cuello", true, true, 1);
		addToArray("images/Buzo/sin_capucha/rugby/frente/botones_sombra.png", "botones", true, false, 3);
		if(act_punio_y_cintura == "tejido")
			addToArray("images/Buzo/sin_capucha/rugby/frente/tejido_blanco.png", "tejido", true, true, 1);

		addToArray("images/Buzo/sin_capucha/rugby/espalda/fondo_blanco.png", "fondo", false, true, 0);
		addToArray("images/Buzo/sin_capucha/rugby/espalda/cuello_blanco.png", "cuello", false, true, 1);
		if(act_punio_y_cintura == "tejido")
			addToArray("images/Buzo/sin_capucha/rugby/espalda/tejido_blanco.png", "tejido", false, true, 1);
		addToArray("images/Buzo/sin_capucha/rugby/espalda/fondo_sombra.png", "fondo", false, false, 2);
	...
	$('#texture_palette > div > div > div > img').on('click', function () {
		...
		if (act_cuello == "en_v_con_capucha") {
			imageObj.src = "images/Buzo/con_capucha/tramas/" + src + aux + ".png";
		} else if (act_cuello == "en_v_sin_capucha") {
			imageObj.src = "images/Buzo/sin_capucha/en_v/trama/frente/" + src + aux + ".png";
		} else if (act_cuello == "rugby_con_capucha") {
			imageObj.src = "images/Buzo/con_capucha/tramas/" + src + aux + ".png";
		} else if (act_cuello == "rugby_sin_capucha") {
			imageObj.src = "images/Buzo/sin_capucha/rugby/Trama/frente/" + src + aux + ".png";
		}
		...
		if (id == "fondo" || id == "cuello") {
			...
			if (act_cuello == "en_v_con_capucha") {
				imageObj2.src = "images/Buzo/con_capucha/tramas/" + src + aux + ".png";
			} else if (act_cuello == "en_v_sin_capucha") {
				imageObj2.src = "images/Buzo/sin_capucha/en_v/trama/espalda/" + src + aux + ".png";
			} else if (act_cuello == "rugby_con_capucha") {
				imageObj2.src = "images/Buzo/con_capucha/tramas/" + src + aux + ".png";
			} else if (act_cuello == "rugby_sin_capucha") {
				imageObj2.src = "images/Buzo/sin_capucha/rugby/Trama/espalda/" + src + aux + ".png";
			}
		}
	...
	$(".btn.btn-design.prev").on("click", function () {
		if (cuello == "en_v_sin_capucha" || cuello == "rugby_sin_capucha") {
			window.location = 'buzos-paso-04.php?cuello="' + act_cuello + '"&bolsillo="' + act_bolsillo + '"';
		} else if (cuello == "en_v_con_capucha" || cuello == "rugby_con_capucha") {
			window.location = 'buzos-paso-05.php?cuello="' + act_cuello + '"&bolsillo="' + act_bolsillo + '"&punio_y_cintura="' + act_punio_y_cintura + '"';
		}
	});

	$(".btn.btn-design.next").on("click", function () {
		$('#checkOut').append('<input type="hidden" name="prenda" value="BUZO"/>');
